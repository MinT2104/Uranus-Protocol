...
export const JobApplication = ({
  ...
  console.log(
    moment("2023-08-25T23:16:58.619+0000").format("DD/MM/YYYY hh:mm:ss a")
  );
  return (
    // <section className="w-full h-fit fixed overflow-auto top-0 z-50">
    <section className="animate-opacity fixed top-0 overflow-auto w-full h-full flex items-center justify-center z-50 py-10">
      <div
